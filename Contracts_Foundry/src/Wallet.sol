...
contract Wallet is BaseAccount, Initializable,UUPSUpgradeable, TokenCallbackHandler{
    ...
    function validateSignature(UserOperation calldata userOp, bytes32 userOpHash) public view returns(uint256){
        uint256 value = _validateSignature(userOp, userOpHash);
        return value;
    }
